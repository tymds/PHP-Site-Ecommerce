        ...
        <div class="login">
            <div class="login__content">
                <div class="login__forms">
                    ...
                    <form method="post" class="login__registre" action="<?= htmlspecialchars(app_url('/register'), ENT_QUOTES, 'UTF-8') ?>" novalidate>
                        ...
                        <div>
                            ...
                            <a class="login__signup" href="<?= htmlspecialchars(app_url('/login'), ENT_QUOTES, 'UTF-8') ?>">Se connecter</a>
                        </div>
                    </form>
                </div>
            </div>
